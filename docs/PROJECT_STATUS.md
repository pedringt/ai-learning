...
- **Staging:** empty. Released in #236 (Sept 20) and moved to Done (issues closed): #232 (Evidence added before the project opens no longer goes to the seed project), #231 (a retry when Baseline analysis fails), #227 (Ask no longer rewrites a quote of an approved fact as "not yet approved"; confirmed with the Ask-quality eval, 8 of 8, and a live production Ask question).

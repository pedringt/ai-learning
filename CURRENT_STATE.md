...
- **Release safety:** use `RELEASE_CHECKLIST.md`, `qa_regression.py`, and the visual baseline before changing the source of truth.
- **Visual baseline:** preserve the stable v95.47-derived frame unless an intentional migration is screenshot-tested.
- **Do not reopen casually:** broad component/design-system consolidation, the cosmetic Capabilities positioning quirk, or site-wide density/polish work.
- **Current substantive priorities:** difficult customer/stakeholder interaction practice and executed eval/failure diagnosis.
- **Persistent source convention:** Library keeps one authoritative `CURRENT-SOURCE-vX.zip`; replace it only after the new package is verified.

...
- Treat attributed direction from a decision-maker to start, expand, approve, or "move forward" on a capability as consequential when it changes scope or approaches a recorded safety/sensitive-domain boundary. Brief or informal wording is still Evidence. If the exact effect on an existing boundary is unclear, surface the ambiguity with state_at_risk or open_question rather than returning no_review.

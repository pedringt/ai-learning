...
class AskSelection(BaseModel):
    model_config = ConfigDict(extra="forbid")
    job: AskJob
    state_ids: list[str] = Field(default_factory=list, max_length=30)
    review_ids: list[str] = Field(default_factory=list, max_length=20)
    blocking_question_ids: list[str] = Field(default_factory=list, max_length=20)
    question_ids: list[str] = Field(default_factory=list, max_length=30)
    history_ids: list[str] = Field(default_factory=list, max_length=30)
...
class AskAnswerSection(BaseModel):
    ...
    items: list[AskAnswerItem] = Field(default_factory=list, max_length=20)
...
class AskSynthesis(BaseModel):
    ...
    sections: list[AskAnswerSection] = Field(default_factory=list, max_length=12)

(() => {
  ...
  function renderOverview(){
    ...
    root.innerHTML = `<section class="overview pristine">
      ...
      ${reviewBanner}
      <section class="ask-panel compact-ask unboxed-ask"><div class="ask-title-row"><div><label for="askInput">Ask what State knows about the project</label><p>Search current understanding, open items, notes, and history.</p></div>${state.result?`<button class="text-button ask-new-session" data-action="new-ask">New ask</button>`:''}</div>

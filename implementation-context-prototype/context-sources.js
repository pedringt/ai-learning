(() => {
  ...
  style.textContent = `
    .workspace-source-strip{display:grid;grid-template-columns:minmax(0,1fr) auto;grid-template-areas:'head action' 'copy copy';gap:7px 16px;align-items:center;margin:2px 0 18px;padding:10px 12px;border:1px solid var(--border,#d9dde3);border-radius:12px;background:var(--accent-soft,#eeebf4);font-size:12px}
    ...
    .workspace-source-strip .workspace-source-action{grid-area:action;white-space:nowrap;margin:0;padding:5px 10px;font-size:12px;border-radius:8px;background:var(--surface,#fff)}

(() => {
  ...
  function reviewCard(r,expanded=true,accordion=false,sourceNote){
    ...
    const recordStyle='width:100%;max-width:none;margin:12px 0 0;padding:0;border:0;border-top:1px solid #d9dde5;border-radius:0;background:transparent;box-shadow:none';

(() => {
  ...
  function reviewCard(r,expanded=true,accordion=false,sourceNote){
    ...
    const rowStyle='width:100%;display:flex;align-items:center;justify-content:space-between;gap:20px;text-align:left;border:0;background:transparent;color:inherit;cursor:pointer;box-sizing:border-box;padding-left:16px!important;padding-right:16px!important';

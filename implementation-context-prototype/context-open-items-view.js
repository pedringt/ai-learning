(() => {
  ...
  function reviewCard(r,expanded=true,accordion=false,sourceNote){
    ...
    const rowStyle='width:100%;display:flex;align-items:center;justify-content:space-between;gap:20px;text-align:left;border:0;background:transparent;color:inherit;cursor:pointer';

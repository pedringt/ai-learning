(() => {
  ...
  function styles(){
    ...
    const s=document.createElement('style');s.id='state-final-feedback';s.textContent=`
      /* Stronger product chrome. */
      .prototype-productbar{background:#dbe7f8!important;border-bottom-color:#c5d4eb!important}
      ...
      body .workspace-attention .attention-item:hover{background:rgba(255,255,255,.22)!important}

      /* Current State utility button should read as a real secondary action. */
      body .project-page .project-head-copy-context{display:inline-flex!important;align-items:center!important;justify-content:center!important;min-height:40px!important;padding:0 15px!important;border:1px solid #c8d6ea!important;border-radius:9px!important;background:#fff!important;color:#28558f!important;box-shadow:0 1px 2px rgba(16,26,49,.04)!important;font-size:12.5px!important;font-weight:750!important}
      ...
      body .open-items-page details.reasoning{margin-top:8px!important;padding-top:8px!important}
      body .open-items-page details.reasoning summary{font-size:11.5px!important;line-height:1.25!important;font-weight:700!important;color:#667085!important}
      body .open-items-page details.reasoning p{margin:6px 0!important;font-size:12.5px!important;line-height:1.42!important;color:#4f5b70!important}
      ...
      body .history-page .history-list,body .history-page .history-entry,body .history-page .history-entry-body{border-left:0!important;border-inline-start:0!important;box-shadow:none!important;transform:none!important;transition:none!important}
      body .history-page .history-list::before,body .history-page .history-list::after,body .history-page .history-entry::before,body .history-page .history-entry::after,body .history-page .history-entry-body::before,body .history-page .history-entry-body::after{content:none!important;display:none!important}
      body .history-page .history-entry:hover,body .history-page .history-entry.is-linked:hover{background:transparent!important;box-shadow:none!important;transform:none!important}
      ...
      /* The older feedback layer created a second clear control. Hide it and own reset here. */
      body #askStateDrawer .state-ask-clear{display:none!important}
      body #askStateDrawer .state-ask-reset{display:none!important;position:absolute!important;right:6px!important;top:50%!important;transform:translateY(-50%)!important;width:30px!important;height:30px!important;border:0!important;border-radius:50%!important;padding:0!important;background:transparent!important;color:#677389!important;font:inherit!important;font-size:20px!important;line-height:30px!important;cursor:pointer!important;box-shadow:none!important;z-index:4!important}
      body #askStateDrawer.has-answer .state-ask-reset{display:block!important}
      body #askStateDrawer.has-answer .ask-state-drawer-form button[type="submit"]{display:none!important}
      body #askStateDrawer.is-editing-answer .state-ask-reset{display:none!important}
      ...
      @media(max-width:760px){
        ...
        body #askStateDrawer .ask-state-drawer-form input{height:42px!important;min-height:42px!important;max-height:42px!important;padding:0 50px 0 12px!important;font-size:14px!important}
        ...
        body #askStateDrawer .state-ask-reset{right:5px!important;width:30px!important;height:30px!important;line-height:30px!important}

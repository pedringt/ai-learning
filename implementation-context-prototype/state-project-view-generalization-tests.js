...
check('Current State uses the shared page header with only the page-level Copy context action',
...
check('the evidence callout remains below metadata with the established outlined Add Evidence action',
  officeHtml.includes('<strong>Something changed?</strong>') &&
  officeHtml.includes('class="btn secondary" data-action="something-changed">Add Evidence</button>'));

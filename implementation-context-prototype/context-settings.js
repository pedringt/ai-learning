(() => {
  ...
  function styles(){
    ...
    style.textContent=`
      ...
      .settings-rule-list{list-style:none;margin:16px 0 0;padding:0;display:grid;gap:9px}
  ...
  async function render(){
    ...
    target.innerHTML=`<article class="page settings-page">
      ...
      <section class="settings-section">
        <div class="settings-section-head"><div><h3>Project</h3><p>Rules State uses when interpreting evidence for Northstar.</p></div></div>
